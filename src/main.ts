...
import { ToDoList } from "./exercicio 2/main";
import { BancoOO } from "./exercicio 3/main";
import { GerenciadorTarefasPessoal } from "./exercicio 4/main";
import { CalculadoraFormas } from "./exercicio 5/main";
import { CadastroProdutos } from "./exercicio 6/main";
...
const banco = new BancoOO();
banco.criarConta(123, 1000);
banco.depositar(123, 500);
banco.sacar(123, 200);
banco.consultarSaldo(123);

const tarefasPessoais = new GerenciadorTarefasPessoal();
